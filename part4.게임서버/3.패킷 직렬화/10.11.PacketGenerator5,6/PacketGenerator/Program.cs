...
namespace PacketGenerator
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if (args.Length >= 1) //Main이 시작될때 args에 인자를 넣어준게 있다면, 
                pdlPath = args[0];
        ...
        public static void ParsePacket(XmlReader r)
        {
            ...
            packetEnums += string.Format(PacketFormat.packetEnumFormat, packetName, ++packetId) + Environment.NewLine + "\t"; //패킷id가 한줄한줄 나오게 줄바꿈 넣어줌. //사실 packetFormat.cs에서 형태를 바꿔줘도 될거같긴한데, 이걸쓰네
