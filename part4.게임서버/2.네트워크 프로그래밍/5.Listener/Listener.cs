...
namespace ServerCore
{
    class Listener
    {
        ...
        public void Init(IPEndPoint endPoint, Action<Socket> onAcceptHandler)
        {
            ...
            _onAcceptHandler += onAcceptHandler; //OnAcceptCompleted가 실행되면, 콜백방식으로 외부 함수에 신호를 보내서 데이터 받기 보내기등의 기능을 실행시키라고 명령할것임.
        ...
        void OnAcceptCompleted(object sender, SocketAsyncEventArgs args)
        {
            ...
            {
                _onAcceptHandler.Invoke(args.AcceptSocket); //이부분이 마치 clientSocket을 만드는것과 같은 부분임
            }
            else
